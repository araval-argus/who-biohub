...
public class ReadBioHubFacilityHandler : IReadBioHubFacilityHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            BioHubFacilityPublicViewModel bioHubFacilityPublicViewModel = _mapper.Map(biohubfacility);
            return new(new ReadBioHubFacilityQueryResponse(bioHubFacilityPublicViewModel));
        }
        catch (Exception e)
        {
