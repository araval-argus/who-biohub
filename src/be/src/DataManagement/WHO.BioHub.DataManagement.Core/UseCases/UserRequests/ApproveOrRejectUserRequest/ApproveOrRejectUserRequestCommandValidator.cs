...
public class ApproveOrRejectUserRequestCommandValidator : AbstractValidator<ApproveOrRejectUserRequestCommand>
{
    public ApproveOrRejectUserRequestCommandValidator()
    {
        ...
        RuleFor(cmd => cmd.ConfirmationDate)
           .NotNull().WithMessage("'Confirmation Date' is required");
