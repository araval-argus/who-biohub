...
public interface IUpdateMaterialForBioHubFacilityCompletionHandler
{
    Task<Either<UpdateMaterialForBioHubFacilityCompletionCommandResponse, Errors>> Handle(UpdateMaterialForBioHubFacilityCompletionCommand command, CancellationToken cancellationToken);
}

public class UpdateMaterialForBioHubFacilityCompletionHandler : IUpdateMaterialForBioHubFacilityCompletionHandler
{
    private readonly ILogger<UpdateMaterialForBioHubFacilityCompletionHandler> _logger;
    private readonly UpdateMaterialForBioHubFacilityCompletionCommandValidator _validator;
    private readonly IUpdateMaterialForBioHubFacilityCompletionMapper _mapper;
    private readonly IMaterialWriteRepository _writeRepository;

    public UpdateMaterialForBioHubFacilityCompletionHandler(
        ILogger<UpdateMaterialForBioHubFacilityCompletionHandler> logger,
        UpdateMaterialForBioHubFacilityCompletionCommandValidator validator,
        IUpdateMaterialForBioHubFacilityCompletionMapper mapper,
    ...
    public async Task<Either<UpdateMaterialForBioHubFacilityCompletionCommandResponse, Errors>> Handle(
        UpdateMaterialForBioHubFacilityCompletionCommand command,
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (command.UserPermissions.Contains(PermissionNames.CanApproveBioHubFacilityCompletion))
            {
            ...
            return new(new UpdateMaterialForBioHubFacilityCompletionCommandResponse(material.Id));
        }
        catch (Exception e)
        {
