...
public class UpdateWorklistFromBioHubItemQEShipmentDocumentsCommandValidator : AbstractValidator<UpdateWorklistFromBioHubItemQEShipmentDocumentsCommand>
{
    private readonly IDocumentReadRepository _documentReadRepository;
    public UpdateWorklistFromBioHubItemQEShipmentDocumentsCommandValidator(IDocumentReadRepository documentReadRepository)
    {
    ...
    protected async Task<bool> IsSMTA2DocumentSigned(UpdateWorklistFromBioHubItemQEShipmentDocumentsCommand cmd, CancellationToken cancellationToken)
    {
