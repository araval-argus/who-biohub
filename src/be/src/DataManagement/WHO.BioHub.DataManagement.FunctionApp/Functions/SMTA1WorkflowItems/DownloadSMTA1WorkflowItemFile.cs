...
public class DownloadSMTA1WorkflowItemFile
{
    private readonly ISMTA1WorkflowItemsController _controller;

    public DownloadSMTA1WorkflowItemFile(ISMTA1WorkflowItemsController controller)
    {
        _controller = controller;
    }

    [FunctionName(nameof(DownloadSMTA1WorkflowItemFile))]
    [OpenApiParameter(
        name: "id",
        Required = true,
    ...
    [OpenApiResponseWithBody(
        ...
        bodyType: typeof(DownloadSMTA1WorkflowItemFileQueryResponse),
    ...
    public async Task<IActionResult> ReadAsync(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "smta1workflowitems/{id:Guid}/downloadfile/{worklistId:Guid}/worklistid")] HttpRequest req,
        ILogger log,
        Guid id,
        Guid worklistId,
