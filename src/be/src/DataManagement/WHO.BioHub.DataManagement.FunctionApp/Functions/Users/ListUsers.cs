...
public class ListUsers
{
    ...
    public ListUsers(IUsersController controller)
    {
        _controller = controller;
    }

    [FunctionName(nameof(ListUsers))]
    [OpenApiOperation(operationId: "ListUser")]
        ...
        CancellationToken funcCancellationToken)
    {
        try
        {
            log.LogInformation("List User function (HttpTrigger) invoked.");
        ...
        {
            log.LogError(e, "Error executing list user function");
