...
public class ReadFile
{
    ...
    public ReadFile(IDocumentTemplatesController controller)
    {
    ...
    [OpenApiResponseWithBody(
        ...
        bodyType: typeof(ReadFileQueryResponse),
    ...
    public async Task<IActionResult> ReadAsync(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "documenttemplates/readfile/{id:Guid}")] HttpRequest req,
        ILogger log,
        Guid id,
        CancellationToken funcCancellationToken)
    {
        try
        {
            log.LogInformation("DocumentTemplate ReadFile function (HttpTrigger) invoked.");
        ...
        {
            log.LogError(e, "Error executing read documenttemplate ReadFile function");
