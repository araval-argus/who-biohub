...
public class UpdateWorklistToBioHubItem
{
    private readonly IWorklistToBioHubItemsController _controller;

    public UpdateWorklistToBioHubItem(IWorklistToBioHubItemsController controller)
    {
        _controller = controller;
    }

    [FunctionName(nameof(UpdateWorklistToBioHubItem))]
    [OpenApiOperation(operationId: "UpdateWorklistToBioHubItem")]
    [OpenApiParameter(
        name: "id",
        Required = true,
    ...
    [OpenApiRequestBody(
        ...
        bodyType: typeof(UpdateWorklistToBioHubItemCommand)
    )]
    [OpenApiResponseWithBody(
        statusCode: HttpStatusCode.OK,
        contentType: "application/json",
        bodyType: typeof(UpdateWorklistToBioHubItemCommandResponse),
    ...
    public async Task<IActionResult> UpdateAsync(
        [HttpTrigger(AuthorizationLevel.Anonymous, "patch", Route = "worklisttobiohubitems/{id:Guid}")] HttpRequest req,
        ILogger log,
        Guid id,
