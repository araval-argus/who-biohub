...
public class ListMapBioHubFacilities
{
    ...
    [OpenApiResponseWithBody(
        ...
        bodyType: typeof(ListMapBioHubFacilitiesQueryResponse),
        ...
        CancellationToken funcCancellationToken)
    {
        try
        {
            log.LogInformation("List Map BioHubFacility function (HttpTrigger) invoked.");
        ...
        {
            log.LogError(e, "Error executing list map biohubfacility function");
