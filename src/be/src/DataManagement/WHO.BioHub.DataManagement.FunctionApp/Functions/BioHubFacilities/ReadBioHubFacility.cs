...
public class ReadBioHubFacility
{
    private readonly IBioHubFacilitiesController _controller;

    public ReadBioHubFacility(IBioHubFacilitiesController controller)
    {
        _controller = controller;
    }

    [FunctionName(nameof(ReadBioHubFacility))]
    [OpenApiParameter(
        name: "id",
        Required = true,
    ...
    [OpenApiResponseWithBody(
        ...
        bodyType: typeof(ReadBioHubFacilityQueryResponse),
    ...
    public async Task<IActionResult> ReadAsync(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "biohubfacilities/{id:Guid}")] HttpRequest req,
        ILogger log,
        Guid id,
        CancellationToken funcCancellationToken)
    {
        try
        {
            log.LogInformation("Read BioHubFacility function (HttpTrigger) invoked.");
