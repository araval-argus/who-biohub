...
internal class MaterialLaboratoryAnalysisInformationConfiguration : IEntityTypeConfiguration<MaterialLaboratoryAnalysisInformation>
{
    public static MaterialLaboratoryAnalysisInformationConfiguration Default => new();

    public void Configure(EntityTypeBuilder<MaterialLaboratoryAnalysisInformation> builder)
    {
        ...
        builder
          ...
          .WithMany(b => b.MaterialLaboratoryAnalysisInformation)
