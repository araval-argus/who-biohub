...
internal class MaterialHistoryConfiguration : IEntityTypeConfiguration<MaterialHistory>
{
    public static MaterialHistoryConfiguration Default => new();
