...
export default class MacroTimeline extends Vue {
  @Prop({
    type: undefined,
    default: WorklistToBioHubStatus.RequestInitiation,
  })
  readonly currentStatus: WorklistToBioHubStatus;

  get PreShipmentPhaseCompleted(): boolean {
    return (
      this.currentStatus >= WorklistToBioHubStatus.SubmitSMTA1ShipmentDocuments
    );
  }

  get ShipmentPhaseCompleted(): boolean {
    return this.currentStatus >= WorklistToBioHubStatus.ShipmentCompleted;
  }
